    ...
    <div id="contenedorFicha">
      ...
      <section id="contenido">
        <p id="resumenFicha">
          ...
          Uno de los hallazgos más interesantes de esta investigación fue el fortalecimiento desde el área de educación
          física, no solo de las habilidades sociales, si no, de las habilidades para la vida y la comunicación
          funcional, las cuales se ven reflejadas a la par en los resultados de cada momento de la estrategia pedagógica
          Es importante resaltar que en los estudiantes con discapacidad se identifica mayor necesidad en el desarrollo
          del pensamiento, la interpretación de acciones, el manejo de elementos del entorno y la comprensión del
          lenguaje en contexto. De aquí nace la necesidad de una flexibilización curricular, una articulación pedagógica
          de las competencias sociales, que permita transformar la experiencia académica de los estudiantes con
          discapacidad cognitiva de grado noveno, en el Colegio Bolivia. (Texto tomado de la fuente)
        </p>
        ...
        <div class="seccionFicha">
          ...
          <p class="contenidoSeccion">Inclusión</p>
        </div>
        <div class="seccionFicha">
